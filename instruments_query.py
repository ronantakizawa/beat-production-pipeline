...
GENRE_PRESETS = {
    ...
    'breakcore': {
        ...
        'melody': {
            'type': ['melodic_oneshot', 'melodic_loop'],
            'name_contains': ['melody', 'melo', 'lead', 'piano', 'bell',
                              'keys', 'synth', 'pluck', 'loop', 'sample',
                              'chime', 'glocken', 'music box'],
            'name_excludes': ['drum', 'kick', 'snare', 'hat', 'clap', '808', 'perc'],
            'is_tonal': True,
            'max_rms_db': -8,
            'max_duration_s': 30.0,
        ...
        'break_loop': {
            'type': ['drum_loop', 'melodic_loop', 'drum_oneshot'],
            'name_contains': ['amen', 'break', 'breakbeat', 'jungle', 'dnb',
                              'loop', 'beat'],
            'name_excludes': ['melody', 'pad', 'bass', 'synth', 'vocal'],
            'min_duration_s': 0.5,
            'score_by': 'crest_factor',
        },
        'fx': {
            'type': ['melodic_oneshot', 'melodic_loop', 'drum_oneshot'],
            'name_contains': ['riser', 'impact', 'downlifter', 'sweep', 'fx',
                              'noise', 'crash', 'reverse', 'swell', 'hit',
                              'transition', 'whoosh'],
            'name_excludes': ['kick', 'snare', 'hat', 'bass', '808'],
            'score_by': 'crest_factor',
        },
    },
    ...
    'progressive_house': {
        ...
        'ride': {
            'type': ['drum_oneshot', 'melodic_oneshot'],
            'name_contains': ['ride', 'rd ', '_rd_', 'rd.', 'cymbal'],
            'name_excludes': ['crash', 'china'],
            'min_duration_s': 0.2,
            'score_by': 'brightness_hz',
        },
        'bass': {
        ...
        'pluck': {
            'type': ['melodic_oneshot'],
            'name_contains': ['pluck', 'stab', 'pizz', 'key', 'bell', 'arp'],
            'name_excludes': ['drum', 'kick', 'snare', 'hat', '808', 'bass', 'pad'],
            'is_tonal': True,
            'max_duration_s': 3.0,
            'score_by': 'pitch_stability_cents',
            'score_ascending': True,
        ...
        'piano': {
            'type': ['melodic_oneshot', 'melodic_loop'],
            'name_contains': ['piano', 'pno', 'keys', 'key', 'epiano', 'e-piano',
                              'rhodes', 'wurlitzer'],
            'name_excludes': ['drum', 'kick', 'snare', 'hat', '808', 'bass', 'pad'],
            'is_tonal': True,
            'max_rms_db': -8,
